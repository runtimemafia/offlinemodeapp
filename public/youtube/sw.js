...
ytcfg.set({
    "EXPERIMENT_FLAGS": {
        ...
        "web_enable_renderer_logger": true,
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20250918.01.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "hl": "en-GB",
            "gl": "IN",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20250918.01.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    var policy = self.trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(unused) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/065eb198\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(policy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/065eb198\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}
